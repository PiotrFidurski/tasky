  ...
  (
    ...
    return (
      <button
        ref={ref}
        className={clsx(
          'flex gap-4 outline-none items-center w-full bg-highlight focus:bg-highlightActive transition-all text-white',
          primary && 'ring-2 ring-highlight focus:ring-highlightActive',
          isMenuItem &&
