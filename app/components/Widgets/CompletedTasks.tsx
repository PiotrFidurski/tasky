    ...
    <div className="w-full border-2 border-highlight rounded-md p-8 bg-slate-900">
      <div className="flex items-center justify-between">
        ...
        <div className="w-full flex justify-end">
          <div className="rounded-full w-36 h-36 border-8 border-light relative">
            <div className="rounded-full absolute inset-[-0.5rem] border-8 z-10 border-light border-t-highlight border-l-highlight" />
